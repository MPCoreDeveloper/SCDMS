...
/// </summary>
public sealed class RecentConnectionsStore(IOptions<ScdmsOptions> options) : IRecentConnectionsStore
{
    ...
    private static string GetSettingsDirectoryPath() => ScdmsPaths.RootDirectory;
